...
type Metric struct {
	...
	CompileDuration *int        `bson:"compileDuration,omitempty" json:"compileDuration,omitempty"`
	FileSizeBytes   *int        `bson:"fileSizeBytes,omitempty" json:"fileSizeBytes,omitempty"`
}
