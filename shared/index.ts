...
export const IMAGE_CONFIG = {
	...
	typography: {
		headingMinSize: 32,
		headingPercentage: 0.075, // 7.5% of max dimension
		subheadingMinSize: 24,
...
export const SUBTITLE_LENGTH_THRESHOLDS = {
	SHORT_MAX: Math.floor(
		MAX_SUBTITLE_LENGTH * LENGTH_DISTRIBUTION.SHORT_PERCENT,
	),
	MEDIUM_MAX: Math.floor(
		MAX_SUBTITLE_LENGTH * LENGTH_DISTRIBUTION.MEDIUM_PERCENT,
	),
